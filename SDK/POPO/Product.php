...
class Product
{
     ...
     * @return $this
     */
    public function addToImages($url, $text)
    {
     ...
     * @return $this
     */
    public function addToCombinations(Combination $combination)
    {
        if (!is_a($combination, 'AvecdoSDK\POPO\Product\Combination')) {
            return $this;
        }

        array_push($this->combinations, $combination->getAll());
